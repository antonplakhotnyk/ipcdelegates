...
SYNC_RETVAL_N<TYPES> operator ()(PARAMS)
{
	return SYNC_RETVAL_N<TYPES>(*this COMA ARGS);
}

template<TMPLATE_PARAMS>
friend class SYNC_RETVAL_N;

#else

SYNC_RETVAL_N operator ()(PARAMS)
{
	return SYNC_RETVAL_N(*this COMA ARGS);
}
